...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    @Override
    @Transactional
    public InvoiceResponseDTO generateInvoice(String userId,String bookingId, Long paymentId) {
        ...
        invoice.setInvoicePdfUrl("http://localhost:8081/api/v1/invoices/user/" + invoice.getInvoiceNumber() + "/download"); 
    ...
    @Override
    @Transactional(readOnly = true)
    public InvoiceResponseDTO getInvoiceByBookingId(String bookingId) {
    ...
    public byte[] downloadInvoiceAsPdf(String invoiceNumber) {
        ...
        ByteArrayOutputStream baos = new ByteArrayOutputStream(); //creates an in-memory stream for writing bytes. You can later retrieve the data as a byte array.
        ...
        try {
            ...
            Font titleFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 24, BaseColor.BLACK); //A utility method to create fonts easily.
